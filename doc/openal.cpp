...
void init(void)
{
    ...
    alutLoadWAVFile((ALbyte*)"c.wav",&format,&data,&size,&freq, &doloop);
    alBufferData(buffer[0],format,data,size,freq);
    alutUnloadWAV(format,data,size,freq);

    alutLoadWAVFile((ALbyte*)"b.wav",&format,&data,&size,&freq, &doloop);
    alBufferData(buffer[1],format,data,size,freq);
    alutUnloadWAV(format,data,size,freq);

    alutLoadWAVFile((ALbyte*)"a.wav",&format,&data,&size,&freq, &doloop);
